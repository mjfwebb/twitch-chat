...
export const ChatEntry = ({
  ...
  const gigantified =
    chatMessage.message_type === "power_ups_gigantified_emote";
  ...
  const user: { displayName: string; avatarUrl: string } = {
    ...
    avatarUrl:
      store.getState().userInformation[chatMessage.chatter_user_id]
        ?.profile_image_url || "",
  };
    ...
    <button className={classNames("chat-message")}>
      <div
        className={classNames(
          "chat-message-body",
          showBorders &&
            chatMessage.badges.find((badge) => badge.set_id === "subscriber") &&
            "chat-message-body-subscriber",
          dropShadowEnabled &&
            thickTextShadowEnabled &&
            "chat-message-body-thick-text-shadow",
      ...
      >
        <span>
          ...
          <span
            ...
            style={{
              color: contrastCorrected(
                chatMessage.color || "#fff",
                backgroundColor
              ),
            }}
          >
