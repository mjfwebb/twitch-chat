        ...
        <Route
          ...
          component={() => (
            <main>
              ...
              <TwitchConnectPage />
              <p>
                Connect your Twitch account to start using the chat overlay.
              </p>
              <p>
                ...
                . If you encounter issues or have feature requests, please check
                the{" "}
                <a href="https://github.com/mjfwebb/twitch-chat/issues">
                  issues page
                </a>
                .
              </p>
